    ...
    return (
      <Layout style={{ minHeight: '100vh' }}>
        <Sider collapsible collapsed={collapsed} onCollapse={this.onCollapse} theme="light">
          ...
          <Menu defaultSelectedKeys={['1']} mode="inline" theme="light">
            <Menu.Item key="1" icon={<PieChartOutlined />}>
              <Link to="/user_manager/application">
                申请
              </Link>
            </Menu.Item>
            <Menu.Item key="2" icon={<DesktopOutlined />}>
            <Link to="/user_manager/company">
                公司
            </Link>
            </Menu.Item>
        ...
        <Layout className="site-layout">
          ...
          <section id="section">
            <Route path="/user_manager/application" component={Application} />
            <Route path="/user_manager/company" component={Company}/>
            <Route path="/user_manager/files" component={Files}/>
