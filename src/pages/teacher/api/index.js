...
export const getChangeCompany=(classNum)=>ajax('http://120.79.147.32:8089/teacher/changeApplications',{start:'1',pageSize:DEFAULT_PAGE_SIZE,teacherClass:classNum})